      ...
      <div className="flex flex-col items-center justify-center gap-10 p-24">
        ...
        <div className="grid w-full gap-5 md:grid-cols-2 lg:px-20">
          <Link href={"/meal-planner?type=daily"}>
            <Card className="cursor-pointer from-primary/40 to-transparent transition duration-300 ease-in-out hover:-translate-y-2 hover:bg-primary/10 hover:bg-linear-to-br">
              <CardHeader>

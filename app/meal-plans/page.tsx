          ...
          <Card className="cursor-pointer from-primary/40 to-transparent transition duration-300 ease-in-out hover:-translate-y-2 hover:bg-primary/10 hover:bg-gradient-to-br">
            ...
            <CardContent className="md:min-h-96">
              <div className="flex flex-col gap-5">
                ...
                <p>
                  Create a personalized meal plan for today. Customize based on
                  your desired diet, number of meals, and personal preferences.
                  Ideal for staying flexible and adapting to your daily
                  nutritional needs.
                </p>
              </div>
            </CardContent>
            ...
            <CardContent className="md:min-h-96">
              <div className="flex flex-col gap-5">
                ...
                <p>
                  ...
                  for those who want a structured and time-saving way to stay on
